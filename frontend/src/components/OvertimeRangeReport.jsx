                            ...
                            <Table size="small" sx={{ bgcolor: 'white', border: '1px solid #e2e8f0', borderRadius: 1 }}>
                                ...
                                <TableBody>
                                    ...
                                    <TableRow sx={{ bgcolor: '#f1f5f9' }}>
                                        <TableCell colSpan={2} sx={{ fontWeight: 800, fontSize: '0.75rem' }}>SUBTOTAL {station}</TableCell>
                ...
                <Table stickyHeader size="small">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="center" sx={{ bgcolor: '#1e293b', color: 'white', fontWeight: 800 }}>HARI DALAM RANGE</TableCell>
                            <TableCell align="center" sx={{ bgcolor: '#1e293b', color: 'white', fontWeight: 800 }}>TOTAL JAM OT RANGE</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
